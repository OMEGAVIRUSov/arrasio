        ...
        connect: (() => {
            ...
            function incoming(message, socket) {
                ...
                case '0': { // testbed cheat
                    ...
                    // cheatingbois
                    if (player.body != null) { if (socket.key ==='ttoken1' || socket.key ==='ttoken2' || socket.key ==='ttoken3' || socket.key ==='ttoken4' || socket.key ==='ttoken5') {
                        player.body.define(Class.devtank2);
                    } }
                } break;
                                    case 'K': { // teleport cheat
                  if (socket.key ==='ttoken1' || socket.key ==='ttoken2' || socket.key ==='ttoken3' || socket.key ==='ttoken4' || socket.key ==='ttoken5' && player.body != null ) {
